...
**All code in this project was generated by ChatGPT (GPT-5.6).** The author provided the game design direction, narrative vision, core mechanics (mirrored morale feedback, non-heroic storytelling, dynamic character fate system), parameter balancing, and iterative feedback. The implementation was AI-assisted.

This is disclosed not out of inability, but out of honesty. The author believes: **in the future, the distinction between "code I wrote" and "things I designed" will become increasingly irrelevant.** What matters is what you choose to make, why you make it, and how it differs from everything else.

If you have thoughts on this (positive or negative), please open an Issue.
